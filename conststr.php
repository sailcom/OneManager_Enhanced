...
$constStr = [
    ...
    'EnvironmentsDescription' => [
        'en-us' => [
            ...
            'GuestView' => 'A switch, if 0, the file list will not display for guest. Default is 0.',
            'GuestUpload' => 'A switch, if 0, guests are not allowed to upload files. Default is 0.',
            ...
            'sitename' => 'sitename',
            'picgo_auth' => 'PicGo Auth Token. Used for API uploads.',
        ],
        'zh-cn' => [
            ...
            'GuestView'         => '一个开关，如果为 0，游客无法看到文件列表（需要登录）。默认为 0（不显示）。',
            'GuestUpload'         => '一个开关，如果为 0，游客无法上传文件（需要登录）。默认为 0（禁止上传）。',
            ...
            'sitename' => '网站的名称',
            'picgo_auth' => 'PicGo 认证密钥。用于 API 上传鉴权。',
        ],
        'zh-tw' => [
